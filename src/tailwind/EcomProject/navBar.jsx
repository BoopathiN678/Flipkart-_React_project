    ...
    return(
        <div className=" bg-[#4949e5]   sm:bg-blue-600 flex items-center justify-around p-2 z-50 sticky top-0">
            ...
            <div className="hidden sm:block ">
                  <Link to ="/cart" className=" flex text-[white] items-center gap-3 text-[17px] font-bold "><FaShoppingCart className="" /><span className=" text-white bg-orange-700  sm:border-2 text-sm absolute top-1 w-5 text-center right-[85px] rounded-3xl">{arr.length}</span>Cart</Link>
            </div>
